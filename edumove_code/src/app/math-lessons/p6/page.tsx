    ...
    <main className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A] relative font-sans overflow-x-hidden pb-20">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16" style={{ fontFamily: "var(--font-prompt), sans-serif" }}>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="group flex flex-col rounded-[2.5rem] bg-white dark:bg-slate-800 border-4 border-slate-900 dark:border-slate-700 p-8 shadow-[8px_8px_0_0_#0F172A] dark:shadow-[8px_8px_0_0_#000] hover:-translate-y-2 hover:shadow-[12px_12px_0_0_#0F172A] dark:hover:shadow-[12px_12px_0_0_#000] transition-all">
              <div className="w-20 h-20 rounded-[1.5rem] border-4 border-slate-900 bg-purple-300 flex items-center justify-center mb-6"><Calculator size={40} className="text-slate-900" strokeWidth={2.5} /></div>
              <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3">รูปเรขาคณิต</h3>
              <p className="font-bold text-slate-600 dark:text-slate-400 mb-8 flex-grow">วงกลม พื้นที่ผิว และรูปสามมิติ</p>
              <Link href="/math-lessons/p6/chapter4" className="w-full bg-slate-100 dark:bg-slate-700 text-center py-4 rounded-2xl font-black text-slate-800 dark:text-white group-hover:bg-purple-500 group-hover:text-white border-4 border-transparent group-hover:border-slate-900 transition-colors active:scale-95 flex justify-center items-center gap-2">เข้าสู่เนื้อหา <PlayCircle size={20}/></Link>
            </div>

            <div className="group flex flex-col rounded-[2.5rem] bg-white dark:bg-slate-800 border-4 border-slate-900 dark:border-slate-700 p-8 shadow-[8px_8px_0_0_#0F172A] dark:shadow-[8px_8px_0_0_#000] hover:-translate-y-2 hover:shadow-[12px_12px_0_0_#0F172A] dark:hover:shadow-[12px_12px_0_0_#000] transition-all">
              <div className="w-20 h-20 rounded-[1.5rem] border-4 border-slate-900 bg-indigo-300 flex items-center justify-center mb-6"><PieChart size={40} className="text-slate-900" strokeWidth={2.5} /></div>
              <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3">สมการและการแก้โจทย์</h3>
              <p className="font-bold text-slate-600 dark:text-slate-400 mb-8 flex-grow">สมการเชิงเส้นตัวแปรเดียวและโจทย์ประยุกต์</p>
              <Link href="/math-lessons/p6/chapter5" className="w-full bg-slate-100 dark:bg-slate-700 text-center py-4 rounded-2xl font-black text-slate-800 dark:text-white group-hover:bg-indigo-500 group-hover:text-white border-4 border-transparent group-hover:border-slate-900 transition-colors active:scale-95 flex justify-center items-center gap-2">เข้าสู่เนื้อหา <PlayCircle size={20}/></Link>
            </div>

            <div className="group flex flex-col rounded-[2.5rem] bg-white dark:bg-slate-800 border-4 border-slate-900 dark:border-slate-700 p-8 shadow-[8px_8px_0_0_#0F172A] dark:shadow-[8px_8px_0_0_#000] hover:-translate-y-2 hover:shadow-[12px_12px_0_0_#0F172A] dark:hover:shadow-[12px_12px_0_0_#000] transition-all">
              <div className="w-20 h-20 rounded-[1.5rem] border-4 border-slate-900 bg-cyan-300 flex items-center justify-center mb-6"><Percent size={40} className="text-slate-900" strokeWidth={2.5} /></div>
              <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-3">สถิติ</h3>
              <p className="font-bold text-slate-600 dark:text-slate-400 mb-8 flex-grow">ค่าเฉลี่ย แผนภูมิรูปวงกลม และการนำเสนอข้อมูล</p>
              <Link href="/math-lessons/p6/chapter6" className="w-full bg-slate-100 dark:bg-slate-700 text-center py-4 rounded-2xl font-black text-slate-800 dark:text-white group-hover:bg-cyan-500 group-hover:text-slate-900 border-4 border-transparent group-hover:border-slate-900 transition-colors active:scale-95 flex justify-center items-center gap-2">เข้าสู่เนื้อหา <PlayCircle size={20}/></Link>
            </div>
          </div>
          ...
          <div className="bg-orange-400 rounded-[2.5rem] p-8 md:p-12 border-4 border-slate-900 shadow-[8px_8px_0_0_#0F172A]">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full md:w-auto">
                <Link href="/math-lessons/p6/challenge2/easy" className="bg-white text-emerald-600 px-6 py-4 rounded-2xl font-black text-xl border-4 border-slate-900 border-b-[8px] active:border-b-4 active:translate-y-[4px] hover:bg-slate-50 transition-all flex justify-between items-center gap-4 min-w-[150px]"><span>🟢 ง่าย</span><ChevronRight strokeWidth={3} /></Link>
