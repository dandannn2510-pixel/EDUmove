...
import { 
  ArrowLeft, Calculator, PieChart, BarChart3, 
  Shapes, Activity, Percent, Star, Target, ChevronRight, PlayCircle, ShieldAlert 
} from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 dark:bg-[#0b1120] dark:text-white relative font-sans selection:bg-fuchsia-200 selection:text-fuchsia-900 dark:selection:bg-fuchsia-500/30 dark:selection:text-white overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16" style={{ fontFamily: "'Prompt', sans-serif" }}>
        ...
        {/* ปุ่มกลับ */}
        <Link href="/grade/p4" className="inline-flex items-center gap-2 text-slate-600 hover:text-fuchsia-600 dark:text-slate-400 dark:hover:text-fuchsia-400 transition-all mb-12 font-bold bg-white/70 dark:bg-slate-800/70 px-6 py-3 rounded-full border border-slate-200 dark:border-slate-700 backdrop-blur-md shadow-sm hover:shadow-md hover:-translate-y-0.5">
