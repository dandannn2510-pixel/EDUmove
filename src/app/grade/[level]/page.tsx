    ...
    <main className="min-h-screen bg-[#F8FAFC] dark:bg-[#0F172A] py-16 px-6 relative font-sans overflow-x-hidden pb-20">
      ...
      <div className="max-w-5xl mx-auto relative z-10" style={{ fontFamily: "var(--font-prompt), sans-serif" }}>
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl md:text-6xl font-black text-slate-900 dark:text-white mb-4">SUBJECT</h1>
          <p className="text-4xl font-bold text-slate-600 dark:text-slate-400">โปรดเลือกวิชาที่ต้องการเรียนรูู้</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Link href={`/lessons/${params.level}`} 
          ...
          <Link href={`/math-lessons/${params.level}`} 
